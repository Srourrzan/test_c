...
CMakeFiles/dephelper/opencv_java_jar: modules/java/jar/opencv/MANIFEST.MF
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspaces/test_c/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating ../../../CMakeFiles/dephelper/opencv_java_jar"
	cd /workspaces/test_c/build/modules/java/jar && /usr/bin/cmake -E touch /workspaces/test_c/build/CMakeFiles/dephelper/opencv_java_jar
	cd /workspaces/test_c/build/modules/java/jar && /usr/bin/cmake -D OPENCV_JAVA_DIR="/workspaces/test_c/build/modules/java/jar/opencv/java" -D OUTPUT="/workspaces/test_c/build/modules/java/jar/opencv/java_sources" -P /workspaces/test_c/image_filter/opencv/modules/java/jar/list_java_sources.cmake
...
CMakeFiles/dephelper/opencv_java_jar_source_copy: CMakeFiles/dephelper/gen_opencv_java_source
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/workspaces/test_c/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Copy Java(JAR) source files"
	/usr/bin/cmake -DCONFIG_FILE:PATH=/workspaces/test_c/build/modules/java/jar/copyfiles-JAVA_SRC_COPY.cmake -DCOPYLIST_VAR:STRING=JAVA_SRC_COPY -DDEPHELPER=/workspaces/test_c/build/CMakeFiles/dephelper/opencv_java_jar_source_copy -P /workspaces/test_c/image_filter/opencv/cmake/copy_files.cmake
...
modules/java/jar/CMakeFiles/opencv_java_jar_sources.dir/clean:
	cd /workspaces/test_c/build/modules/java/jar && $(CMAKE_COMMAND) -P CMakeFiles/opencv_java_jar_sources.dir/cmake_clean.cmake
