...
void display_calendar(WINDOW *win) {
    ...
    int start_day = first_day.tm_wday; // Day of the week (0=Sun, 6=Sat)
    int days_in_month = 31; // Simplified, adjust for actual month later

    // Print calendar days
    for (int i = 0; i < start_day; i++) wprintw(win, "   "); // Leading spaces
